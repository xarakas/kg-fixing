...
public class ModuleReasoningLog {
     ...
     */
    public ModuleReasoningLog(String baseIndividual, int outerRound, int innerRound, long checkConsistencyTimeMillis, long checkRepairabilityTimeMillis, long getExplanationsTimeMillis, long computeFixesTimeMillis, int explanationsCount) {
     ...
     */
    public static ModuleReasoningLog fromObjectNode(ObjectNode root) {
     ...
     */
    public static ModuleReasoningLog fromJsonString(String json) {
        try {
            ObjectMapper mapper = new ObjectMapper();
