...
public class ModuleEventLog {
     ...
     * The type of event.
     */
    private final ModuleEvent eventType;
     ...
     */
    public ModuleEventLog(String baseIndividual, ModuleEvent eventType, LocalDateTime localDateTime) {
    ...
    public ObjectNode toObjectNode() {
        ...
        objectNode.put("baseIndividual", this.baseIndividual);
     ...
     */
    public static ModuleEventLog fromObjectNode(ObjectNode node) {
        String baseIndividual = node.get("baseIndividual").asText();
        ...
        return new ModuleEventLog(baseIndividual, Enum.valueOf(ModuleEvent.class, eventType), localDateTime);
    }
     ...
     */
    public static ModuleEventLog fromJsonString(String json) {
        try {
            ObjectMapper mapper = new ObjectMapper();
    ...
    /**
     * Gets the variable name for the base individual.
     * @return The variable name for the base individual.
     */
     ...
     */
    public ModuleEvent getEventType() {
