...
public class MyInnerRoundNumLog {
     ...
     */
    public MyInnerRoundNumLog(int outerRound, int innerRoundNum) {
     ...
     */
    public static MyInnerRoundNumLog fromObjectNode(ObjectNode root) {
        int outerRound = root.get("outerRound").asInt();
        int innerRoundNum = root.get("innerRoundNum").asInt();
        return new MyInnerRoundNumLog(outerRound, innerRoundNum);
    }
     ...
     */
    public static MyInnerRoundNumLog fromJsonString(String json) {
        try {
            ObjectMapper mapper = new ObjectMapper();
