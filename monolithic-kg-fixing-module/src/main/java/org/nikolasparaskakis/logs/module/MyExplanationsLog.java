...
public class MyExplanationsLog {
     ...
     */
    public MyExplanationsLog(int outerRound, int innerRound, List<List<OWLAxiom>> explanations) {
     ...
     */
    public static MyExplanationsLog fromObjectNode(ObjectNode root) {
        ...
        return new MyExplanationsLog(outerRoundNode.asInt(), innerRoundNode.asInt(), explanations);
    }
     ...
     */
    public static MyExplanationsLog fromJsonString(String json) {
        ObjectMapper mapper = new ObjectMapper();
        try {
