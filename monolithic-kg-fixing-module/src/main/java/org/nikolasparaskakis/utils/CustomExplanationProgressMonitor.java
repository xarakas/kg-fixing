...
public class CustomExplanationProgressMonitor<E> implements ExplanationProgressMonitor<E> {
     ...
     */
    public CustomExplanationProgressMonitor() {
        this(Duration.ZERO, Integer.MAX_VALUE, true);
    }
     ...
     */
    public CustomExplanationProgressMonitor(Duration timeout, int maxExplanations) {
        this(timeout, maxExplanations, true);
    }
     ...
     */
    public CustomExplanationProgressMonitor(Duration timeout, int maxExplanations, boolean printAxioms) {
    ...
    public void foundExplanation(ExplanationGenerator<E> generator, Explanation<E> explanation, Set<Explanation<E>> allFoundExplanations) {
        ...
        if (printAxioms && toRecord != null) {
            ...
            System.out.println("##################################################");
            System.out.println("Found explanation (callback #" + seen + ")");
