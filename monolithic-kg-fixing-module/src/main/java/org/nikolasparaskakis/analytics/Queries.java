...
//import org.nikolasparaskakis.logs.module.MyInnerRoundNumLog;
//import org.nikolasparaskakis.logs.module.ModuleReasoningLog;
//import org.nikolasparaskakis.logs.module.MySizeLog;
//
//
//
///**
...
//        return "SELECT " +
//                MySizeLog.getOuterRoundVarName() + " as outerRound, " +
//                "ROUND(AVG( " + MySizeLog.getModuleSizeVarName() + " ), 2) as avgModuleSize, " +
//                "ROUND(STDDEV( " + MySizeLog.getModuleSizeVarName() + " ), 2) as stdModuleSize, " +
//                "MAX( " + MySizeLog.getModuleSizeVarName() + " ) as maxModuleSize " +
//                "FROM " + this.moduleSizeLogsTable + " " +
//                "GROUP BY outerRound " +
//                "ORDER BY outerRound";
//    }
...
//        if (clazz == MyInnerRoundNumLog.class) {
//            return "SELECT " +
//                    MyInnerRoundNumLog.getOuterRoundVarName() + " as outerRound, " +
//                    "ROUND(AVG(" + MyInnerRoundNumLog.getInnerRoundNumVarName() + "), 2) as avgInnerRoundNum, " +
//                    "ROUND(STDDEV(" + MyInnerRoundNumLog.getInnerRoundNumVarName() + "), 2) as stdInnerRoundNum, " +
//                    "MAX(" + MyInnerRoundNumLog.getInnerRoundNumVarName() + ") as maxInnerRoundNum " +
//                    "FROM " + this.moduleInnerRoundNumLogsTable + " " +
//                    "WHERE " + MyInnerRoundNumLog.getInnerRoundNumVarName() + " > 0 " +
//                    "GROUP BY outerRound " +
//                    "ORDER BY outerRound";
//        }
...
//        return "SELECT " +
//                MySizeLog.getOuterRoundVarName() + " as outerRound, " +
//                MySizeLog.getBaseIndividualVarName() + " as baseIndividual, " +
//                MySizeLog.getModuleSizeVarName() + " as moduleSize " +
//                "FROM " + this.moduleSizeLogsTable + " " +
