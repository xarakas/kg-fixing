...
//
//    public CustomConfInconsistentOntologyExplanationGeneratorFactory(OWLReasonerFactory reasonerFactory, OWLDataFactory df, Supplier<OWLOntologyManager> m) {
...
//        this.m = m;
////        this.conf = conf;
//        consistencyEntailmentCheckerFactory = new CustomConfConsistencyEntailmentCheckerFactory(reasonerFactory, m, df);
//    }
//
//
//    @Override
