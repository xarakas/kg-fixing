...
public class ModuleFixesLog {
     ...
     */
    public ModuleFixesLog(String baseIndividual, int outerRound, int innerRound, Set<ArrayList<Fix>> fixes) {
    ...
    public ObjectNode toObjectNode() {
        ...
        root.put("baseIndividual", baseIndividual);
     ...
     */
    public static ModuleFixesLog fromObjectNode(ObjectNode node) {
        ...
        return new ModuleFixesLog(baseIndividual, outerRound, innerRound, fixesOfModule);
    }
     ...
     */
    public static ModuleFixesLog fromJsonString(String json) {
        try {
            ObjectMapper mapper = new ObjectMapper();
